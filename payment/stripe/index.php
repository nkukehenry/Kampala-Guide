...
<table class="table is-fullwidth">
  <tbody>
    ...
    <tr>
      ...
      <form action="pay.php?id_offer=<?php echo $offer_id ?>&email_user=<?php echo $email_user; ?>" method="post" id="PayForm">
      </form>
    ...
    <p style="font-size: 13px; color: #9E9E9E; margin-top: 10px;"><?php echo $st_securecheckout; ?> Stripe <i class="icon ion-md-lock"></i></p>
