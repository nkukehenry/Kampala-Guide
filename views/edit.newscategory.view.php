...
<div class="form-row">
   ...
   <label>Image: <a href="<?php echo SITE_URL ?>/images/<?php echo $newscategory['news_category_image']; ?>" data-lightbox="image-1">Preview</a></label><br/>
   
   <input type="hidden" value="<?php echo $newscategory['news_category_image']; ?>" name="news_category_image_save">
   <div class="input-file-container">  
    <input class="input-file" name="news_category_image" id="my-file" type="file">
