...
$sql = "SELECT * FROM places_types WHERE place_type_category='".$_GET["category"]."' ORDER BY place_type_id DESC";
...
{	
    ...
    $types[] = array(
    	...
    	'place_type_name'=> html_entity_decode($place_type_name),
