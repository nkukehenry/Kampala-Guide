...
$sql = "SELECT offers.*,offers_categories.offer_category_name AS category_name FROM offers,offers_categories WHERE offers.offer_category = offers_categories.offer_category_id AND offers.offer_id != '".$_GET["id"]."' AND offers.offer_category='".$_GET["category"]."' ORDER BY offer_id DESC";
